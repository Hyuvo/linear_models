...
```
    ...
    ## 3 Borough: Brooklyn    -49.8      2.23    -22.3  6.32e-109
    ## 4 Borough: Queens      -77.0      3.73    -20.7  2.58e- 94
    ## 5 Borough: Bronx       -90.3      8.57    -10.5  6.64e- 26
...
```
    ...
    ## Did you want `data = c(price, stars, borough, room_type)`?
